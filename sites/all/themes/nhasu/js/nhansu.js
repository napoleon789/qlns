jQuery(document).ready(function($) {
   ...
   var m =  $(".page-quanly-kpi-kiemsoat #edit-loc-theo-0").attr("checked");
   if(m) {
       ...
       $(".page-quanly-kpi-kiemsoat .container-inline-date").hide();
       $(".page-quanly-kpi-kiemsoat .form-item-cac-quy").show();
       $(".page-quanly-kpi-kiemsoat .form-item-nam-quy").show();
   }
    $(".page-quanly-kpi-kiemsoat #edit-loc-theo-1").click(function() {
       $(".container-inline-date").hide();
       $(".form-item-cac-quy").show();
       $(".form-item-nam-quy").show();
    });
    $(".page-quanly-kpi-kiemsoat #edit-loc-theo-0").click(function() {
        $(".form-item-cac-quy").hide();
        $(".form-item-nam-quy").hide();
        $(".container-inline-date").show();
    });
