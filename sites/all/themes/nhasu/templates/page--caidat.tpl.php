  ...
  <div id="main-wrapper" class="clearfix"><div id="page-wrapper"><div id="main" class="clearfix">
              ...
              <?php if ($tham == 'kpi' || !isset($tham)):?>
                  <ul class="menu_student">
                      <li class="item menu1 active"><a href="<?php echo $base_url;?>/caidat/kpi">Thư viện KPI</a> </li>
              ...
              <?php if ($tham == "phongban"):?>
                  <ul class="menu_student">
                      <li class="item menu1"><a href="<?php echo $base_url;?>/caidat/kpi">Thư viện KPI</a> </li>
                      <li class="item menu2 active"><a href="<?php echo $base_url;?>/caidat/phongban">Phòng ban</a> </li>
                      <li class="item menu3"><a href="<?php echo $base_url;?>/caidat/user">User</a> </li>
                  </ul>
              <?php endif; ?>
