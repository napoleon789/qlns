    ...
    Drupal.behaviors.nhansu_kpi = {
        attach: function (context, settings) {
                    ...
                    success: function(){
                        google.load('visualization', '1', {packages:['corechart'], 'callback' : function()
                        {
                            jQuery.ajax({
                                type: "POST",
                                dataType: "json",
                                url: 'http://qlns.drupalvietnam.com/load/'+tid+'/'+nid,
            ...
            jQuery("#danhgia_kpi #edit-selected-phong").change(function() {
                var tid = $(this).val();
                var nid = $("#edit-selected").val();
                jQuery('.noidung').html('<div class="loadding"><img src="http://qlns.drupalvietnam.com/sites/all/modules/nhansu_chart/images/bx_loader.gif" /></div>');
                jQuery.ajax({
                    type: "POST",
                    dataType: "json",
                    url: 'http://qlns.drupalvietnam.com/danhgia_kpi/'+tid+'/'+nid,
                    success: function(output) {
                        var right = output.right;
                        console.log(right);
